...
const { listarConsultas, cadastrarConsulta, atualizarDadosPaciente, cancelarConsulta, finalizarConsulta, listarMedico, ListarlaudoMedico } = require('../controladores/controladorConsulta')
